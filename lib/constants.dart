...
const kPrimaryColor = Color(0xFFFFF97B3);
...
class ImageNames {
  ...
  static final settingsIcon = "$imagePath/ic_settings.svg";
  static final addIcon = "$imagePath/ic_add.png";
  static final sunIcon = "$imagePath/ic_sun.svg";
  static final moonIcon = "$imagePath/ic_moon.svg";
}
